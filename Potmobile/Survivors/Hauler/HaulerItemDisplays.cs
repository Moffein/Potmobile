...
namespace Potmobile.Survivors.Hauler
{
    internal class HaulerItemDisplays
    {
        ...
        public static void RegisterDisplays()
        {
            ...
            itemRules.Add(ItemDisplayCore.CreateGenericDisplayRule(RoR2Content.Items.Pearl, "DisplayPearl", "armatureRoot", new Vector3(0F, 3.67725F, 0F), new Vector3(90F, 0F, 0F), new Vector3(0.99546F, 0.99546F, 0.99546F)));
            itemRules.Add(ItemDisplayCore.CreateGenericDisplayRule(RoR2Content.Items.ShinyPearl, "DisplayShinyPearl", "armatureRoot", new Vector3(0F, 3.67725F, 0F), new Vector3(90F, 0F, 0F), new Vector3(0.99546F, 0.99546F, 0.99546F)));
