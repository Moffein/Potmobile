    ...
    public class ItemDisplayCore
    {
        ...
        private static void PopulateDisplays()
        {
            ...
            foreach (var item in itemDisplayPaths)
            {
                ...
                if (!loadedObject)
                {
                    Debug.LogError($"[Potmobile]ItemDisplayCore.LoadAddressable:: Issue loading path for \"{item.Key}\" with path \"{item.Value}\".");
                    continue;
                }
        ...
        public class IDRS_MirrorComponent : MonoBehaviour
        {
            ...
            public FlipType flipType = FlipType.None;
            ...
            public void FixedUpdate()
            {
                if (parentTransform && childTransform)
                {
                    ...
                    switch (flipType)
                    {
                        case FlipType.None:
                            break;
                        case FlipType.Mirrored:
                            childTransform.localPosition = new Vector3(
                                parentTransform.localPosition.x * -1,
                                parentTransform.localPosition.y,
                            ...
                            childTransform.localScale = new Vector3(
                                ...
                                parentTransform.localScale.z * -1);
                            break;
                        case FlipType.ZMirrored:
                            childTransform.localPosition = new Vector3(
                                parentTransform.localPosition.x * -1,
                                parentTransform.localPosition.y,
                                parentTransform.localPosition.z
                            ...
                            childTransform.localScale = new Vector3(
                                parentTransform.localScale.x * -1,
                                parentTransform.localScale.y,
